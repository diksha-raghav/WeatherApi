...
public class DBUtil {
	...
	static {
		...
		ds_dmdatabase.setDriverClassName(DbProperties_Live.jdbc_driver);
		ds_dmdatabase.setJdbcUrl(DbProperties_Live.jdbcUrl_dmnative);
		ds_dmdatabase.setUsername(DbProperties_Live.dmnative_user);
		ds_dmdatabase.setPassword(DbProperties_Live.dmnative_password);
		ds_dmdatabase.setMaximumPoolSize(DbProperties_Live.dmapp_MaximumPoolSize);
		ds_dmdatabase.setMinimumIdle(DbProperties_Live.MinimumIdle);
		ds_dmdatabase.setLeakDetectionThreshold(DbProperties_Live.LeakDetectionThreshold);
		ds_dmdatabase.setConnectionTestQuery("SELECT 1");
		ds_dmdatabase.setConnectionTimeout(DbProperties_Live.ConnectionTimeout);

		// datasource for WFMS
		ds_wfms.setDriverClassName(DbProperties_Live.jdbc_driver);
		ds_wfms.setJdbcUrl(DbProperties_Live.jdbcUrl_wfms);
		ds_wfms.setUsername(DbProperties_Live.user);
		ds_wfms.setPassword(DbProperties_Live.password);
		ds_wfms.setMaximumPoolSize(DbProperties_Live.wfms_MaximumPoolSize);
		ds_wfms.setMinimumIdle(DbProperties_Live.MinimumIdle);
		ds_wfms.setLeakDetectionThreshold(DbProperties_Live.LeakDetectionThreshold);
		ds_wfms.setConnectionTestQuery("SELECT 1");
		ds_wfms.setConnectionTimeout(DbProperties_Live.ConnectionTimeout);

		// datasource for Weather
		ds_weather.setDriverClassName(DbProperties_Live.jdbc_driver);
		ds_weather.setJdbcUrl(DbProperties_Live.jdbcUrl_weather);
		ds_weather.setUsername(DbProperties_Live.user);
		ds_weather.setPassword(DbProperties_Live.password);
		ds_weather.setMaximumPoolSize(DbProperties_Live.weather_MaximumPoolSize);
		ds_weather.setMinimumIdle(DbProperties_Live.MinimumIdle);
		ds_weather.setLeakDetectionThreshold(DbProperties_Live.LeakDetectionThreshold);
		ds_weather.setConnectionTestQuery("SELECT 1");
		ds_weather.setConnectionTimeout(DbProperties_Live.ConnectionTimeout);
	}
...
//		return getHikariConnection("wfms", "root", "Aicnet@123");
	 ...
	 * 
	 * config.setJdbcUrl(DbProperties_Live.jdbcUrl);
	 * config.setUsername(DbProperties_Live.user);
	 * config.setPassword(DbProperties_Live.password);
	 * 
	 * 
