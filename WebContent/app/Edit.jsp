...
<body >
	...
	<div class="main-body-section">
		...
		<form action="/WeatherApi/editController" method="post" id="EditForm" enctype="multipart/form-data">
		<c:forEach items="${users}" var="user">	
				...
				<div class="row  g-3 row-grid mt-5">
					...
					<div class="form-group col-md-3 mb-5 ">
						<label class="field" for="sel1">District <span
							...
							<option value="${user.district}" selected hidden>${user.district}</option>
							<option disabled>--Select--</option>
						</select>
					</div>
					<div class="form-group col-md-3 mb-5 ">
						<label class="field" for="sel1">L4 <span
							...
							<option value="${user.l4}" selected hidden>${user.l4}</option>
							<option disabled>--Select--</option>
						</select>
					</div>
					<div class="col-md-3 mb-5">
						<label for="inputL5" class="form-label field">L5 <!-- 							<span style="color: red; font-size: large;">*</span> -->
						</label> <input type="text" name="l5" id="L5" class="form-control"
							placeholder="L5" aria-label="L5" value="${user.l5}">
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3 mb-5 ">
						<label for="inputUsername" class="form-label field">Name of the User<span style="color: red; font-size: large;">*</span>
						</label> <input type="text" name="username" id="uname" required
							class="form-control" placeholder="Name of the User"
							aria-label="User name" value="${user.user}">
					</div>
					<div class="col-md-3 mb-5 ">
						<label for="inputdesignation" class="form-label field">Designation<span
							style="color: red; font-size: large;">*</span></label> <select
							name="designation" class="form-control" id="desig" required>
							<option value="${user.designation}" selected hidden>${user.designation}</option>
							<option disabled>--Select--</option>
					...
					<div class="col-md-3 mb-5 md-form ">
						<label class="control-label field" for="date">Date Of
							Birth <span style="color: red; font-size: large;">*</span>
						</label> <input class="form-control" required name="dob" id="dateofbirth"
							placeholder="YYYY-MM-DD" type="date" value="${user.dob}"
							max="2003-12-31" readonly/>
					</div>
					<div class="col-md-3 mb-5 ">
						<label for="inputMobile" class="form-label field">Mobile <span
							...
							value="${user.mobile1}" maxlength="10" readonly>
						<p id="alertmobile"></p>
					</div>
					<div class="col-md-3 mb-5">
						<label for="inputAlternateMobile" class="form-label field">Alternate
							...
							title="Phone number with 6-9 and remaing 9 digit with 0-9"
							value="${user.mobile2}" maxlength="10" onchange="checknum();">
						<p id="alertmobile"></p>
					</div>
					<div class="col-md-3 mb-5 ">
					...
					<div class="form-group col-md-3 mb-5 ">
						...
						<select name="educational_qualification" class="form-control"
							id="qual">
							<option value="${user.education_qualification}" selected hidden>${user.education_qualification}</option>
							<option disabled>--Select--</option>
							<option>10th</option>
							<option>12th</option>
					...
					<div class="col-md-3 mb-5 ">
						<label for="inputLocatedAt" class="form-label field">Located
							...
							aria-label="Located At" value="${user.office_location}">
					</div>
					<div class="col-md-3 mb-5 ">
						<label for="inputyears" class="form-label field">Experience
							...
							value="${user.exp_crop_ins_year}" class="form-control"
							placeholder="In years" aria-label="years" pattern="[0-9]{2}"
							max="99" min="0">
					</div>
					<div class="col-md-3 mb-5">
						<label for="inputmonths" class="form-label field">Experience
							In Crop Insurance <span style="color: red; font-size: large;">*</span>
						</label> <input type="number" required name="exp_crop_ins_month"
							value="${user.exp_crop_ins_month}" id="months"
							class="form-control" placeholder="In Months" aria-label="months"
							pattern="[0-9]{2}" max="11" min="0">
					</div>
		...
		<c:forEach var="intermediaries" items="${intermediaries}">
				...
				<div class="h2">Intermediary Details</div>
					<div class="row">
						<div class="form-group col-md-3 mb-5 ">
							<label class="field" for="sel1">Type 
							...
							<select name="intermediary_type" class="form-control" id="intermediary_type" required>	
								<option value="${intermediaries.intermediaryType}" selected hidden>${intermediaries.intermediaryType}</option>
								<option disabled>Select</option>
...
<%-- 							</c:forEach> --%>
					...
					<div class="form-group col-md-3 mb-5 ">
					<label class="field" for="sel1">Name </label> <span 
							style="color: red; font-size: large;">*</span></label> 
							<select name="intermediary_name" class="form-control" id="intermediary_name" required>
							<option value="${intermediaries.intermediaryName}" selected hidden>${intermediaries.intermediaryName}</option>
							<option disabled>--Select--</option>
						</select>
					</div>
						...
						<div class="col-md-3  mb-5">
							<label for="" class="form-label field">Spoc Name</label> <input
								...
								placeholder="" id="int_spoc_name" aria-label="" value="${intermediaries.intSpocName}">
						</div>
						
						<div class="col-md-3  mb-5">
							<label for="" class="form-label field">Email ID</label> <input
								type="text" name="int_emailid" class="form-control"
								placeholder="" id="int_emailid" aria-label=""
								value="${intermediaries.intermediaryMail}">
						</div>
						...
						<div class="col-md-3  mb-5">
							<label for="inputBank_Branch_Address" class="form-label field">Phone
								...
								aria-label="" value="${intermediaries.intermediaryMobile}">
						</div>
						...
						<div class="col-md-6  mb-5">
							...
							<input type="text" name="int_address" class="form-control"
								placeholder="" id="int_address" aria-label=""
								value="${intermediaries.intermediaryAddress}">
						</div>
				...
				<div class="row">
					...
					<div class="form-group col-md-3 mb-5 ">
						<label class="field" for="sel1">ID Type <span
							...
							<option value="${user.doc_type}" selected hidden>${user.doc_type}</option>
							<option disabled>Select</option>
					...
					<div class="col-md-3 mb-5 ">
						<label for="inputphotoid" class="form-label field">Upload
							ID Proof <!-- 						<span style="color: red; font-size: large;">*</span> -->
						</label> <input name="photo_card" type="file" class="form-control" accept="application/pdf,image/png,image/jpeg">
						<p style="font-size:16px;"><a href="/WeatherApi/FileDownload?mobile1=${user.mobile1}">
						<img src="images/document.jpg" width="20" height="20"/>View Image</p></a>
					</div>

					<!-- <div class="col-md-3 mb-5 ">
					<label for="inputphotoid" class="form-label field">
						PAN/Aadhar/Passport <span style="color: red; font-size: large;">*</span>
					</label> <input name="photo_card" required type="file" class="form-control"
					...
					<div class="col-md-3 mb-5 ">
						<label for="inputphotocardid" class="form-label field">Photo
							...
							placeholder="ID Number" aria-label="ID Number" id="photo"
							value="${user.card_id}" maxlength="16">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-3 mb-5 ">
						...
						<input type="text" name="banf_ifsc" class="form-control"
							value="${user.banf_ifsc}" placeholder="Bank IFSC"
							aria-label="Bank IFSC" id="ifscno" maxlength="11" minlength="11">
					</div>
					<div class="form-group col-md-3 mb-5 ">
						<label class="field" for="sel1">Bank Name</label> <select value=""
							name="bank_name" class="form-control" id="bank_name">
							<option value="${user.bank_name}" selected hidden>${user.bank_name}</option>
							<option disabled>--Select--</option>
						</select>
					</div>
					<div class="col-md-3  mb-5">
						<label for="inputBank_Branch_Name" class="form-label field">Bank
							...
							value="${user.bank_branch}" aria-label="Bank Branch Name"
							id="branch">
					</div>
					<div class="col-md-3  mb-5">
						<label for="inputBank_Branch_State" class="form-label field">Bank
							Branch State</label> <input type="text" name="bank_state"
							class="form-control" placeholder="Bank Branch State"
							value="${user.bank_state}" aria-label="Bank Branch State"
							id="bankstate">
					</div>
					<div class="col-md-12  mb-5">
						<label for="inputBank_Branch_Address" class="form-label field">Bank
							...
							aria-label="Bank Branch Address"
							value="${user.bank_branch_address}">
					</div>
				</div>
				...
				<div class="col-md-12">
					<div class="submitbuttondiv">
						<span > <input type="submit" value="Update"
							class="mainsubmit" name="btn_update" id="submit_btn"
							onsubmit="return Validate()" /><input
							style="background-color: #4CAF50;" value="Edit"
							class="mainsubmit" id="redirect_btn" /> <input
							style="background-color: #4CAF50;" value="Back"
							class="mainsubmit" id="back_btn" />
						</span>
					</div>
				</div>
			</form>
	...
	const urlParams = new URLSearchParams(queryString);
		...
		const mobile1=urlParams.get('mobile1');
// 		alert(page_type);
		if(page_type=="readonly"){
// 			alert("inside readonly");
			  ...
			  $("#back_btn").click(function(){
				  window.location.href = "/WeatherApi/ViewController";
			  });
			  $("#redirect_btn").click(function(){
				  location.href = "/WeatherApi/editController?mobile1="+mobile1;
				});	 
			 ...
			 $("#redirect_btn").hide();
			$("#back_btn").click(function(){
				  location.href = "/WeatherApi/editController?id=readonly&mobile1="+mobile1;
				});
		}
    }); 
	</script>
				...
				buttons: {
				  ...
				  switch (value) {
				    ...
				    case "view":
				      ...
				      break;
				    //case "edit":
				    //	window.location.href = "/WeatherApi/editController";
				    //	break;
				  }
			});
