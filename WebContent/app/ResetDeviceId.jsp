...
<body >
	...
	<div class="main-body-section">
		...
		<form class="" id="form-reset" method="post" action="/WeatherApi/ResetDeviceController">
			...
			<div >
				<div class="form-group d-flex align-items-center justify-content-center">	
					...
					<button class="btn btn-primary" style="background-color: green;" type="submit">Reset Device ID</button>
				</div>
			</div>
			...
			swal({
				...
				buttons: {
				  ...
				  switch (value) {
				    ...
				    case "Reset":
				    	window.location.href = "/WeatherApi/app/ResetDeviceId.jsp";
				      break;
				    case "home_page":
