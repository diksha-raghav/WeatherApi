...
var actual=["A & N ISLAND","HARYANA","ARUNACHAL PRADESH","ASSAM","MEGHALAYA",
	"NAGALAND","MANIPUR","MIZORAM","TRIPURA","SIKKIM","WEST BENGAL","ODISHA","JHARKHAND",
	"BIHAR","UTTAR PRADESH","UTTARAKHAND","CHANDIGARH (UT)","DELHI (UT)","PUNJAB","HIMACHAL PRADESH",
	"JAMMU & KASHMIR (UT)","LADAKH (UT)","RAJASTHAN","MADHYA PRADESH","GUJARAT","DADAR & NAGAR HAVELI (UT)",
	"DAMAN & DIU (UT)","GOA","MAHARASHTRA","CHHATTISGARH","COASTAL AP and YANAM","ANDHRA PRADESH",
	"TAMIL NADU","PUDUCHERRY (UT)","KARNATAKA","KERALA & MAHE","LAKSHADWEEP"] ;
